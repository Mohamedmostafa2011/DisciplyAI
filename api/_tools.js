...
export const TOOL_SCHEMAS = [
  ...
  { name: 'get_fixed_commitments', description: 'Read the student\'s recurring fixed commitments (school, tutoring, training).', parameters: { type: 'object', properties: {} } },
  { name: 'get_subjects', description: 'Read the list of subjects the student studies.', parameters: { type: 'object', properties: {} } },
...
export const DONE_LABELS = {
  ...
  get_fixed_commitments: 'Done — commitments loaded.',
  get_subjects: 'Done — subjects loaded.',
...
export async function executeTool(name, args = {}, ctx = {}) {
  switch (name) {
    ...
    case 'get_fixed_commitments':
      return { items: await Notion.getFixedCommitments() };
    case 'get_subjects':
      return { items: (await Notion.getSubjects()).map((s) => s.title) };
...
You manage the student's academic information stored in Notion databases: Tasks, Homework, Fixed Commitments and Subjects.
