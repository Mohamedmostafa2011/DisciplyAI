...
export const DATABASES = {
  ...
  fixedCommitments: {
    ...
    id: env('NOTION_DB_COMMITMENTS', 'PASTE_COMMITMENTS_DATABASE_ID_HERE'),
    properties: {
      title:     { name: 'Name',      type: 'title'        },
      day:       { name: 'Day',       type: 'multi_select' }, // e.g. Monday, Tuesday
      startTime: { name: 'Start',     type: 'rich_text'    }, // e.g. "17:00"
      endTime:   { name: 'End',       type: 'rich_text'    },
  ...
  subjects: {
    label: 'Subjects',
    id: env('NOTION_DB_SUBJECTS', 'PASTE_SUBJECTS_DATABASE_ID_HERE'),
    properties: {
      title:   { name: 'Name',    type: 'title'  },
      teacher: { name: 'Teacher', type: 'rich_text' },
      code:    { name: 'Code',    type: 'rich_text' }
    }
  }
};
