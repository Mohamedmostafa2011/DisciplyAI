...
## STEP 3 — Get your 4 Notion database IDs

For **each** database (Tasks, Homework, Fixed Commitments, Subjects):
...
`name: 'Task name'`. Do the same for all four databases. Commit and push.
